...
public class DecTreeUsingInfoGain

{
	...
	public void decomposeNodeInfoGain(TreeNode node) {
		...
		for (int j=0; j< numvalues; j++) {
			...
			decomposeNodeInfoGain(node.children[j]);
	...
	public void createDecisionTreeusingIGain() {
		...
		System.out.println("Tree using info gain");
		decomposeNodeInfoGain(root);
		printTree(root, "");
