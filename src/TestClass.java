...

{
	...
	public void printTree(TreeNode node, String tab) {
		...
		if (node.children == null) {
			...
			for (int i=0; i < values.length; i++) {
				...
				System.out.print("\"" + domains[outputattr].elementAt(i) + "\"");
	...
	public static void main(String[] args) throws Exception {
		...
		TestClass me = new TestClass();

		//int status = me.readData("E:\\Documents\\SUNY SB\\ACADS\\ML\\hw3\\hw3dt_data.dat");
		int status = me.readData("C:\\Users\\sundi133\\Downloads\\fall2011\\ML\\ass3\\shuttle_ext_unique.dat");
		//C:\Users\sundi133\Downloads\fall2011\ML\ass3\shuttle_ext_unique.dat
